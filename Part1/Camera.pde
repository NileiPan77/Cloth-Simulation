...
class Camera
{
  Camera()
  {
    position      = new PVector(  -150.47446, 307.6205, 269.68973); // initial position
    theta         = -1.3645958; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = 0.029773261; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
