...
class Camera
{
  Camera()
  {
    position      = new PVector(-105.284065, -77.34562, 196.34444); // initial position
    theta         = -0.4935836; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.3589394; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 100;
